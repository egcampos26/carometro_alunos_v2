...
const StudentCreate: React.FC<StudentCreateProps> = ({ onCreate, user, onToggleRole }) => {
        ...
        return (
            ...
            >
                <div className="flex flex-col items-center justify-center h-[70vh] p-8 text-center space-y-4">
                    <h2 className="text-2xl font-black text-gray-900 uppercase">Acesso Restrito</h2>
                    <p className="text-gray-500 max-w-xs mx-auto font-medium">Você não tem permissão para adicionar alunos.</p>
                </div>
            </Layout>
        );
    }
                ...
                <form onSubmit={handleSave} className="flex flex-col lg:flex-row gap-8 lg:gap-16">
                    ...
                    <div className="flex-1 space-y-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-[#3b5998] text-[10px] font-black uppercase block tracking-widest ml-1">Período</label>
                                <select
                                ...
                                >
                                    ...
                                    <option value={Shift.INTEGRAL}>Integral</option>
                                </select>
                            </div>
                            ...
                            <div className="space-y-2 col-span-1 md:col-span-2">
                                ...
                                <select
                                    className="w-full p-4 bg-gray-50 border-2 border-transparent focus:bg-white focus:border-[#3b5998] rounded-2xl text-gray-800 font-bold outline-none transition-all appearance-none"
                                    value={formData.imageRightsSigned}
