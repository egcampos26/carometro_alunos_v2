...
import { UserCheck, Calendar, Save, Eye, EyeOff, Search, CheckCircle2, X, Users, ShieldAlert, Plus, Clock } from 'lucide-react';
...
const OccurrenceEdit: React.FC<OccurrenceEditProps> = ({ students, occurrences, onUpdateOccurrence, onAddOccurrence, onDeleteOccurrence, user }) => {
  ...
  const headerTitle = (
    <div className="flex flex-col items-center justify-center leading-tight">
      <span className="text-sm sm:text-3xl font-black tracking-tighter uppercase">EDITAR OCORRÊNCIA</span>
    </div>
  );
